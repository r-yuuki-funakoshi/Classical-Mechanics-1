...
ρ = input("1000 kg/m^-3 for water, 700-950 for unsaturated oil, and 1 for air :", )
Cd = input("0.47 for sphere, 1 for a square shaped object", )
...
while True:
    ...
    #Air drag
    F_air = (1 / 2) * ρ * dot(object.velocity, object.velocity) * Cd * A * (-object.velocity / mag(object.velocity)) * q
    F_air2 = (1 / 2) * ρ * dot(object2.velocity, object2.velocity) * Cd * A2 * (-object2.velocity / mag(object2.velocity)) * q
    F_air3 = (1 / 2) * ρ * dot(object3.velocity, object3.velocity) * Cd * A3 * (-object3.velocity / mag(object3.velocity)) * q
    F_air4 = (1 / 2) * ρ * dot(object4.velocity, object4.velocity) * Cd * A4 * (-object4.velocity / mag(object4.velocity)) * q
    ...
    a = Fnet / object.mass
    a2 = Fnet2 / object2.mass
    a3 = Fnet3 / object3.mass
    a4 = Fnet4 / object4.mass
    object.velocity += a * dt
    object2.velocity += a2 * dt
    object3.velocity += a3 * dt
    object4.velocity += a4 * dt
    ...
    g2_1.plot(t, object.velocity.y / t)
    g2_2.plot(t, object2.velocity.y / t)
    g2_3.plot(t, object3.velocity.y / t)
    g2_4.plot(t, object4.velocity.y / t)
    g3_1.plot(t, object.velocity.y * object.mass / t)
    g3_2.plot(t, object2.velocity.y * object2.mass / t)
    g3_3.plot(t, object3.velocity.y * object3.mass / t)
    g3_4.plot(t, object4.velocity.y * object4.mass / t)

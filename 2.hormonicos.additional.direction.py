...
object = sphere(pos = vec(-2, -2, -5), radius = 0.5, color = color.cyan, emissive = True,
...
while True:
    ...
    object.force = -spring.k_stiffness * (mag(object.pos - equilibrium_pos) - mag(equilibrium_pos)) * (object.pos - equilibrium_pos) / mag(object.pos - equilibrium_pos)
